...
import HealerSessionsPage from './pages/healer/SessionLogPage';
import HealerSessionDetailsPage from './pages/healer/SessionsRecordPage';
import HealerSessionNotesPage from './pages/healer/SessionNotesPage';
import HealerDocumentsPage from './pages/healer/DocumentsPage';
import HealerProfilePage from './pages/healer/ProfilePage';
    ...
    <IonSplitPane contentId="main">
      ...
      <IonRouterOutlet id="main">
        ...
        <Route path={ROUTES.HEALER.PATIENT_DETAILS} exact={true}>
          <HealerPatientDetailsPage />
        </Route>
        <Route path={ROUTES.HEALER.SESSIONS} exact={true}>
          <HealerSessionsPage />
        </Route>
        <Route path={ROUTES.HEALER.SESSION_DETAILS} exact={true}>
          <HealerSessionDetailsPage />
        </Route>
        <Route path={ROUTES.HEALER.SESSION_NOTES} exact={true}>
          <HealerSessionNotesPage />
        </Route>
